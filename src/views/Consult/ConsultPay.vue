...
import { getPatientDetail } from '@/services/consult'
...
<template>
  <div class="consult-pay-page">
    ...
    <div class="pay-info">
      ...
      <p class="desc"><span>极速问诊</span> <span>自动分配医生</span></p>
    </div>
    <van-cell-group>
    ...
    <van-cell-group>
      ...
      ></van-cell>
      <van-cell title="病情描述" :label="store.consult.illnessType"></van-cell>
    </van-cell-group>
